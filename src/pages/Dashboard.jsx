 ...
 <div className="max-w-5xl mx-auto px-6 py-10 font-sans text-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
                <div className="border border-gray-300 shadow-sm flex flex-col items-center">
                    <div className="bg-[#23d647] w-full text-white font-bold py-3 text-center text-base">Bokashi</div>
                ...
                <div className="border border-gray-300 shadow-sm flex flex-col items-center">
                    <div className="bg-[#23d647] w-full text-white font-bold py-3 text-center text-base">Kompos</div>
                    <div className="py-10 flex flex-col items-center">
                ...
                <div className="border border-gray-300 shadow-sm flex flex-col items-center">
                    <div className="bg-[#23d647] w-full text-white font-bold py-3 text-center text-base">Eco-enzyme</div>
                    <div className="py-10 flex flex-col items-center">
            ...
            <div className="border border-gray-200 p-8 mb-16 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-6">
                    ...
                    <div className="flex justify-end items-end mt-4 md:mt-0 gap-3">
                        <button className="bg-[#e30000] text-white text-sm font-bold py-2 px-8 rounded hover:bg-green-500 transition-colors">
                            Reset
                        </button>
